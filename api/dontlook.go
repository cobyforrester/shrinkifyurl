// I was having a lot of trouble getting it to
// return or read in a file. I would need to look
// closer into how the directory/path works.
// I just wanted to sleep after coding all day for work
